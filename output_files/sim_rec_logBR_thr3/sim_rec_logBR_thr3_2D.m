...
bestfit = [    0.24495E+01    0.17188E+03];
mean = [    0.24589E+01    0.14763E+03];
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_2_cont'));
pdfpts=load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_2_marg'));
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_2_cont'));
profpts = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_2_profl'));
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_2_cont'));
scpts = load('sim_rec_logBR_thr3/sim_rec_logBR_thr3_single.txt');
...
subplot(    2,    2,    2);
box on; axis square; hold on;
bestfit = [    0.43897E+00    0.17188E+03];
mean = [    0.20122E+00    0.14763E+03];
refpoint = [    0.92400E+00    0.33800E+02];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p3.dat'));
 x1 = tmp(:,1);
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_3_cont'));
pdfpts=load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_3_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_3_cont'));
profpts = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_1_3_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
subplot(    2,    2,    3);
box on; axis square; hold on;
bestfit = [    0.24495E+01    0.18230E+00];
mean = [    0.24589E+01    0.27258E+00];
refpoint = [    0.27520E+01    0.76000E-01];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p2.dat'));
 x1 = tmp(:,1);
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_2_cont'));
pdfpts=load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_2_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_2_cont'));
profpts = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_2_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
subplot(    2,    2,    4);
box on; axis square; hold on;
bestfit = [    0.43897E+00    0.18230E+00];
mean = [    0.20122E+00    0.27258E+00];
refpoint = [    0.92400E+00    0.76000E-01];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p3.dat'));
 x1 = tmp(:,1);
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_3_cont'));
pdfpts=load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_3_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_3_cont'));
profpts = load (fullfile('../../plot_data/sim_rec_logBR_thr3/','sim_rec_logBR_thr3_2D_20_3_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
print -dpsc2 ../../output_files/sim_rec_logBR_thr3/sim_rec_logBR_thr3_2D_marg.ps;
figure(   4)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/sim_rec_logBR_thr3/sim_rec_logBR_thr3_2D_profl.ps;
figure(   5)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/sim_rec_logBR_thr3/sim_rec_logBR_thr3_2D_single.ps;
