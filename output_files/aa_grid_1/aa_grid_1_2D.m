...
bestfit = [    0.24000E+01    0.19000E+03];
mean = [    0.24545E+01    0.14535E+03];
...
tmp = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_2D_1_2_cont'));
pdfpts=load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_2D_1_2_marg'));
...
tmp = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_2D_1_2_cont'));
profpts = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_2D_1_2_profl'));
...
tmp = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/aa_grid_1/','aa_grid_1_2D_1_2_cont'));
scpts = load('aa_grid_1/aa_grid_1_single.txt');
...
print -dpsc2 ../../output_files/aa_grid_1/aa_grid_1_2D_marg.ps;
figure(   4)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/aa_grid_1/aa_grid_1_2D_profl.ps;
figure(   5)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/aa_grid_1/aa_grid_1_2D_single.ps;
