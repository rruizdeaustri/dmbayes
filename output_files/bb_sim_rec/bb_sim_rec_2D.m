...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_2_cont'));
pdfpts=load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_2_marg'));
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_2_cont'));
profpts = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_2_profl'));
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_2_cont'));
scpts = load('bb_sim_rec/bb_sim_rec_single.txt');
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_3_cont'));
pdfpts=load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_3_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_3_cont'));
profpts = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_1_3_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_2_cont'));
pdfpts=load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_2_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_2_cont'));
profpts = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_2_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_3_cont'));
pdfpts=load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_3_marg'));
contourf(x1,x2,pdfpts,64);
[C h] = contour(x1,x2,pdfpts,cnt(           1,:),l1);set(h,'LineWidth',lw1);
shading flat;
hold on;
...
tmp = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_p20.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_3_cont'));
profpts = load (fullfile('../../plot_data/bb_sim_rec/','bb_sim_rec_2D_20_3_profl'));
ah=imagesc(x1,x2,profpts);
shading flat;
hold on;
text('String', '\it{SuperBayeS v 1.36}','FontSize',names_fontsize, 'Units', 'normalized', 'Position', [1.0 1.05], 'HorizontalAlignment', 'right');
...
print -dpsc2 ../../output_files/bb_sim_rec/bb_sim_rec_2D_marg.ps;
figure(   4)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/bb_sim_rec/bb_sim_rec_2D_profl.ps;
figure(   5)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/bb_sim_rec/bb_sim_rec_2D_single.ps;
