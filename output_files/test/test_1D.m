...
bestfit = [    0.60887E+02 0.0];
mean = [    0.67093E+02, 0.0];
...
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_1.ps;
figure
subplot(    4,    2,    2);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.21243E+01 0.0];
mean = [    0.21835E+01, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_2.ps;
figure
subplot(    4,    2,    3);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.21507E-02 0.0];
mean = [    0.47468E-01, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_3.ps;
figure
subplot(    4,    2,    4);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.42681E-02 0.0];
mean = [    0.40000E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/test/','test_p7.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_4.ps;
figure
subplot(    4,    2,    5);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.20777E-02 0.0];
mean = [    0.47297E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/test/','test_p8.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_5.ps;
figure
subplot(    4,    2,    6);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.26690E+00 0.0];
mean = [    0.22482E+00, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/test/','test_p9.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_6.ps;
figure
subplot(    4,    2,    7);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.12789E-02 0.0];
mean = [    0.12461E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/test/','test_p10.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_7.ps;
figure
subplot(    4,    2,    8);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.72332E+00 0.0];
mean = [    0.62796E+00, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/test/test_1D_8.ps;
