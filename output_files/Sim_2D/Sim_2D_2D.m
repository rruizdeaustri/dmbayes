...
bestfit = [    0.26245E+01    0.26635E+03];
mean = [    0.26360E+01    0.27373E+03];
refpoint = [    0.23500E+01    0.16750E+03];
tmp = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_p2.dat'));
 x1 = tmp(:,1);
tmp = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_2D_1_2_cont'));
pdfpts=load (fullfile('../../plot_data/Sim_2D/','Sim_2D_2D_1_2_marg'));
...
tmp = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_2D_1_2_cont'));
profpts = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_2D_1_2_profl'));
...
tmp = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_p1.dat'));
 x2 = tmp(:,1);
cnt = load (fullfile('../../plot_data/Sim_2D/','Sim_2D_2D_1_2_cont'));
scpts = load('Sim_2D/Sim_2D_single.txt');
...
print -dpsc2 ../../output_files/Sim_2D/Sim_2D_2D_marg.ps;
figure(   4)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/Sim_2D/Sim_2D_2D_profl.ps;
figure(   5)
set(gcf, 'PaperUnits','centimeters');
set(gcf, 'PaperPosition',[ 0 0 20 20]);
set(gcf, 'PaperType', 'A4');
set(gcf, 'PaperOrientation', 'portrait'); 
print -dpsc2 ../../output_files/Sim_2D/Sim_2D_2D_single.ps;
