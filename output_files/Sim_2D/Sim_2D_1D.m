...
bestfit = [    0.26635E+03 0.0];
mean = [    0.27373E+03, 0.0];
...
hold off;
print -dpsc2 -loose  ../../output_files/Sim_2D/Sim_2D_1D_1.ps;
figure
subplot(    2,    1,    2);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.26245E+01 0.0];
mean = [    0.26360E+01, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/Sim_2D/Sim_2D_1D_2.ps;
