...
bestfit = [    0.59956E+02 0.0];
mean = [    0.67200E+02, 0.0];
...
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_1.ps;
figure
subplot(    4,    2,    2);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.21303E+01 0.0];
mean = [    0.21831E+01, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_2.ps;
figure
subplot(    4,    2,    3);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.34484E-02 0.0];
mean = [    0.50957E-01, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_3.ps;
figure
subplot(    4,    2,    4);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.29853E-02 0.0];
mean = [    0.38862E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/aa_sim_rec/','aa_sim_rec_p7.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_4.ps;
figure
subplot(    4,    2,    5);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.36589E-01 0.0];
mean = [    0.46984E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/aa_sim_rec/','aa_sim_rec_p8.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_5.ps;
figure
subplot(    4,    2,    6);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.25882E+00 0.0];
mean = [    0.22190E+00, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/aa_sim_rec/','aa_sim_rec_p9.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_6.ps;
figure
subplot(    4,    2,    7);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.12092E-02 0.0];
mean = [    0.13164E-01, 0.0];
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/aa_sim_rec/','aa_sim_rec_p10.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_7.ps;
figure
subplot(    4,    2,    8);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
bestfit = [    0.69695E+00 0.0];
mean = [    0.62814E+00, 0.0];
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/aa_sim_rec/aa_sim_rec_1D_8.ps;
