...
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_1.ps;
figure
subplot(    4,    2,    2);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_2.ps;
figure
subplot(    4,    2,    3);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_3.ps;
figure
subplot(    4,    2,    4);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr1/','sim_rec_logBR_thr1_p7.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_4.ps;
figure
subplot(    4,    2,    5);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr1/','sim_rec_logBR_thr1_p8.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_5.ps;
figure
subplot(    4,    2,    6);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr1/','sim_rec_logBR_thr1_p9.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_6.ps;
figure
subplot(    4,    2,    7);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
refpoint = [   -0.40000E+01 0.0];
tmp = load (fullfile('../../plot_data/sim_rec_logBR_thr1/','sim_rec_logBR_thr1_p10.dat'));
x = tmp(:,1);
pdf = tmp(:,2);
hbar = bar(x,pdf);
set(hbar, 'EdgeColor', 'b','FaceColor', [0.4 0.8 1.0],'BarWidth', 1.0);
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_7.ps;
figure
subplot(    4,    2,    8);
set(gcf, 'NextPlot', 'replacechildren');
box on; axis square; hold on;
...
set(gcf, 'PaperSize',[16.5 16.5]);
hold off;
print -dpsc2 -loose  ../../output_files/sim_rec_logBR_thr1/sim_rec_logBR_thr1_1D_8.ps;
