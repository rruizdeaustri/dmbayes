...
contains
    ...
    function default_params(nDims,root)
        ...
        do i=1,nDims
            ...
            call add_parameter(default_params,trim(adjustl(paramname)),trim(adjustl(latex)),1,uniform_type,1,1,[ 0d0 , 1d0 ])
        end do
    ...
    subroutine get_params(file_name,params,derived_params) 
        ...
        integer                                  :: sub_cluster_block ! sub_clustering_block
        ...
        do 
            ...
            !6) Sub-clustering block
            call next_element(line_buffer,'|')    ! advance
            read(line_buffer,*) sub_cluster_block ! read in integer
            ...
            call add_parameter(params,paramname,latex,speed,prior_type,prior_block,sub_cluster_block,prior_params) 
        ...
        do 
            ...
            ! Add this parameter to the array
            call add_parameter(derived_params,paramname,latex,0,0,0,0,prior_params) 
        end do
