                    ...
                    if(replace_point(settings,RTI,baby_points,cluster_id) ) then
                        ...
                        if( cyc(RTI%ndead,settings%nlive) ) then
                            ...
                            if(settings%do_clustering) then
                                ...
                                if(allocated(settings%sub_clustering_sets)) then
                                    do i=1,size(settings%nsub_clustering_sets)
                                        if(do_clustering(settings,RTI,settings%sub_clustering_sets(i,:settings%nsub_clustering_sets(i)))) then
#ifdef MPI
                                            master_epoch = master_epoch+1
#endif
                                        end if
