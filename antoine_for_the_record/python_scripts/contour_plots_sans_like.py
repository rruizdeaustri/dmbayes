...
homedir = '/Users/francoisrecanati/Desktop/Stage_Imperial/SEPTEMBRE/46PSMN/BG_26_PS_only_oldproc/'
contourpath = homedir #+ '10PSdat/'
#contourpath_true = contourpath + 'pseudotrue/'
savedir = contourpath
outfiles = np.array(['Data.png','Model.png','Residual.png'])
prefixes = np.array(['data_','model_','residual_'])


# Number of l,b bins and Energy bins are hard-coded in for now--FIX later
Ebins = 15 # because problem with data_15 in a file ... ?
bins = 60
