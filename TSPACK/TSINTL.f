...
C                IER < 0.
C
C Modules required by TSINTL:  INTRVL_TSPACK, SNHCSH_TSPACK
C
...
C
      IL = INTRVL_TSPACK (XL,N,X)
      IU = INTRVL_TSPACK (XU,N,X)
...
C
        ...
        CALL SNHCSH_TSPACK (SB1, SM1,CM1,CMM1)
        E = SIG*SM - CMM - CMM
...
C
        SB2 = SIG*B2
        CALL SNHCSH_TSPACK (SIG, SM,CM,CMM)
        CALL SNHCSH_TSPACK (SB2, SM2,CM2,CMM2)
        E = SIG*SM - CMM - CMM
